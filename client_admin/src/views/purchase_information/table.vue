		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','user_name')" min-width="200">
					...
					<el-table-column prop="user_phone" @sort-change="$sortChange" label="用户电话"
				v-if="user_group == '管理员' || $check_field('get','user_phone')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/purchase_information/table','set') || $check_action('/purchase_information/view','set') || $check_action('/purchase_information/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
