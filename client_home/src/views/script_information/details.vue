<template>
	<div class="diy_details page_script_information" id="script_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_script_information'>
							<div_script_information :obj="obj"></div_script_information>
...
<script>
	import div_script_information from "@/components/diy/div_script_information.vue";
	...
	export default {
		...
		data(){
			return{
				...
				list_comment: [],
				form_comment: {
					source_table: "script_information",
					source_field: "script_information_id",
					source_id: 0,
					reply_to_id: 0,
				},
				count_pages: 1, // 页面数
		...
		methods:{
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.script_information_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "script_information",
					source_field: "script_information_id",
					source_id: obj["script_information_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "script_information",
					source_field: "script_information_id",
					source_id: this.obj["script_information_id"],
					user_id
				};
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
								query.title = this.obj.script_name
																																							query.img = this.obj.script_cover
