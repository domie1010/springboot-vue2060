<template>
	<div class="diy_details_box diy_div_script_collage">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/script_collaboration_information/edit','add')" @click="to_form('/script_collaboration_information/edit')" > 加入拼团 </button>
										</div>
						<!-- 富文本 -->
