<template>
	<div class="diy_details_box diy_div_quality_store">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/quality_store/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var quality_store_id = this.obj.quality_store_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "quality_store",
          source_field: "quality_store_id",
          source_id: quality_store_id
        }, (res) => {
