<template>
	<div class="diy_details_box diy_div_script_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											...
											<button class="btn btn-primary details_btn" v-if="$check_action('/script_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var script_information_id = this.obj.script_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "script_information",
          source_field: "script_information_id",
          source_id: script_information_id
        }, (res) => {
